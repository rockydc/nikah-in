...
<head>
    ...
    <link rel="stylesheet" href="{{url('user/abdul/assets/scss/styles.css')}}">
...
<audio loop id="myaudio" type="audio/mp3">
    <source src="{{url('user/abdul/MALIQ  DESSENTIALS -MENARI.mp3')}}">
</audio>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="/user/abdul/assets/img/{{$modalimg}}" />
                    <div class="mt-4">
