...
<head>
    ...
    <link rel="stylesheet" href="{{url('user/ardy/assets/scss/style.css')}}">
    <style>
...
<div class="modal" role="dialog" tabindex="-1" id="myModal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/ardy/assets/img/AditIka4.jpeg')}}" />
                    <div class="mt-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <div class="mb-3">
                            <img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3 text-center">Beautiful in White - Shane Filan<br /></span>
                        </div>
    ...
    <script src="{{url('user/ardy/assets/js/countdown.js')}}"></script>
    <script>
