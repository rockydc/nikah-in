...
<head>
    ...
    <link rel="stylesheet" href="{{url('user/peter/assets/scss/style.css')}}">
    <style>
...
<audio loop id="myaudio" type="audio/mp3">
    <source src="{{url('user/peter/assets/Christina Perri - A Thousand Year.mp3')}}">
</audio>
<div class="modal" role="dialog" tabindex="-1" id="myModal">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/peter/assets/img/bg-header.png')}}" />
                    <div class="mt-4">
                        <p class="text-center">Wedding of<br /></p>
                        <h1>Peter &amp; Melita<br /></h1>
                    ...
                    <div><img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3">A Thousand Years - Christina Perri<br /></span>
        ...
        <div class="container-fluid"><a class="navbar-brand" href="https://nikah-in.com"><img class="mr-2" src="{{url('template/jasmine/assets/img/Nikahin-removebg-preview.png')}}" style="width: 32px;height: 32px;">Nikah-in</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link active cool-link js-scroll-trigger" href="#story">Cerita</a></li>
    ...
    <script src="{{url('user/peter/assets/js/countdown.js')}}"></script>
    <script>
