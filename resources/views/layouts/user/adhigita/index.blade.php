...
<head>
    ...
    <link rel="stylesheet" href="{{url('user/adhigita/assets/scss/style.css')}}">
    <style>
...
<source src="{{url('user/adhigita/canon.mp3')}}">
</audio>
<div class="modal" role="dialog" tabindex="-1" id="myModal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/adhigita/assets/img/4.webp')}}" />
                    <div class="mt-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center flex-column">
                        <div class="mb-3">
                            <img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3 text-center">Canon in D (Pachelbel's Canon) - Cello & Piano<br /></span>
                        </div>
    ...
    <script src="{{url('user/adhigita/assets/js/countdown.js')}}"></script>
    <script>
