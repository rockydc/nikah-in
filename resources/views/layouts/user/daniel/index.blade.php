...
<audio loop id="myaudio" type="audio/mp3">
    <source src="{{url('user/daniel/Sara Bareilles - I Choose You Lyrics (HD).mp3')}}">
</audio>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/daniel/assets/img/_ARY7242-min.JPG')}}" />
                    <div class="mt-4">
                        <p class="text-center">Wedding of<br /></p>
                        <h1>Daniel &amp; Gabriela<br /></h1>
                    ...
                    <div><img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3">I Choose You - Sara Bareilles <br /></span>
...
<nav class="navbar navbar-light navbar-expand-md fixed-top " id="mainNav">
    ...
    <script src="{{url('user/daniel/assets/js/countdown.js')}}"></script>
