    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/ficry/assets/img/SKO00050-min.JPG')}}" />
                    <div class="mt-4">
                        <p class="text-center">Wedding of<br /></p>
                        <h1>Facry &amp; Fitriya<br /></h1>
                    ...
                    <div><img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3">Ten Thousand More - Jungkook version<br /></span>
...
<nav class="navbar navbar-light navbar-expand-md fixed-top " id="mainNav">
    ...
    <script src="{{url('user/ficry/assets/js/countdown.js')}}"></script>
