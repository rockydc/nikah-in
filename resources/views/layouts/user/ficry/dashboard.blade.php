...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('ficrydashboard')}}">
...
<li class="nav-item active">
    <a class="nav-link" href="{{route('ficrydashboard')}}">
...
<!-- Nav Item - rsvp -->
<li class="nav-item active">
    <a class="nav-link" href="{{route('ficryrsvp')}}">
...
<script type="text/javascript">
                $(document).ready(()=>{
                  ...
                  <script src="{{url('user/ficry/assets/js/chart.js')}}"></script>
</body>
