...
<head>
    ...
    <link rel="stylesheet" href="{{url('user/ferry/assets/scss/style.css')}}">
    <style>
...
<source src="{{url('user/ferry/Shane Filan - Beautiful In White.mp3')}}">
</audio>
<div class="modal" role="dialog" tabindex="-1" id="myModal">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/ferry/assets/img/RENJANA-0291bg-min.jpg')}}" />
                    <div class="mt-4">
                        <p class="text-center">Wedding of<br /></p>
                        <h1>Ferry &amp; Nitia<br /></h1>
                    ...
                    <div><img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3">Beautiful in White - Shane Filan<br /></span>
    ...
    <script src="{{url('user/ferry/assets/js/countdown.js')}}"></script>
    <script>
