...
<audio loop id="myaudio" type="audio/mp3">
    <source src="{{url('user/riowira/Maher Zain - Baraka Allahu Lakuma (128 kbps).mp3')}}">
</audio>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="section-modal"><img class="img-header" src="{{url('user/riowira/assets/img/img2.jpg')}}" />
                    <div class="mt-4">
                    ...
                    <div><img src="{{url('template/jasmine/assets/img/fluent_music-note-2-24-filled.svg')}}" /><span class="ml-3">Baraka Allahu Lakuma - Maher Zain<br /></span>
...
<nav class="navbar navbar-light navbar-expand-md fixed-top " id="mainNav">
    ...
    <script src="{{url('user/riowira/assets/js/countdown.js')}}"></script>
