    ...
    <div id="harga" class="section-harga">
        ...
        <div class="container">
            <div data-aos="zoom-in" class="product-wrapper">
                ...
                <h1 class="text-left ml-5" style="font-family: Poppins, sans-serif;font-size: 30px;font-weight: 700;">Rp. 200 ribu</h1><a data-bs-hover-animate="pulse" class="btn btn-undangan" href="#">Buat Undangan</a>
            </div>
        </div>
    </div>
