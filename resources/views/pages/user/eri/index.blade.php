...
@extends('layouts.user.eri.index')
...
<div class="carousel slide carousel-fade" data-ride="carousel" id="carousel-1">
        ...
        @if($value['isActive'] == true)
            <div class="carousel-item active "><img class="w-100 d-block" src="/user/eri/assets/img/{{$value['img']}}" alt="Slide Image" style="object-position: 40% 15%;"></div>
         
         @else
            <div class="carousel-item"><img class="w-100 d-block" src="/user/eri/assets/img/{{$value['img']}}" alt="Slide Image" style="object-position: 40% 15%;"></div>
        @endif
            @endforeach
        </div>
        <!-- <div>
            ...
            <div class="container">
                <div>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4"><img class="img-profile" src="/user/eri/assets/img/{{$profilecowo['foto']}}"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4"><img class="img-profile" src="/user/eri/assets/img/{{$profilecewe['foto']}}"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="section-guest" class="section">
        ...
        <!-- <img class="img-guest" src="{{url('aness/assets/img/guest_attendance-removebg-preview.png')}}"> -->
            <div class="form-wrapper p-lg-4 p-md-4 p-sm-1">
                <form action="{{route('eristore')}}" method="post">
                @csrf 
    ...
    <div id="section-gallery" class="section text-center">
        ...
        <div class="img-wrapper"><img  class="img-items" src="/user/eri/assets/img/{{$value}}"></div>
        @endforeach
    ...
    <div id="share-the-love" class="section text-center">
        ...
        <div class="wrapper-love d-flex justify-content-center align-items-center flex-column">
            <p style="letter-spacing: 4px;color: rgb(126,99,79);"> We Also Provide Cash Less
                ...
                <img class="mt-4 img-barcode" src="/user/eri/assets/img/{{$value['img']}}">
