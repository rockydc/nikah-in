@extends('layouts.user.ferry.index')

@section('title')

Nikah-in | Ferry Nitia
@endsection
...
<header class="text-center" style="margin-top: -70px;">
        <div class="header-wrap">
            ...
            <h1 style="font-family: 'Playfair Display', serif;">Ferry &amp; Nitia</h1>
            ...
            <div class="photo-wrap">
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div><img data-aos="fade-up" src="{{url('user/ferry/assets/img/profile-cowo.png')}}">
                            <h1 data-aos="fade-up" class="mt-5 text-name">Ferry Firmansyah</h1>
                            <p data-aos="fade-up" style="font-family: Montserrat, sans-serif;">Putra dari bapak H. Zubirman dan ibu Hj. Titi Suparti<br></p>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div><img data-aos="fade-up" src="{{url('user/ferry/assets/img/profile-cewe.png')}}">
                            <h1 data-aos="fade-up" class="mt-5 text-name">Nitia Ningsih</h1>
                            <p data-aos="fade-up" style="font-family: Montserrat, sans-serif;">Putri dari bapak Ikhsan Idris dan ibu Rustimah<br></p>
...
bila mendoakan seseorang yang nikah, beliau bersabda:</p>
    ...
    <section id="galeri" class="section-galeri">
        ...
        <div class="gallery-wrap container">
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="200" src="{{url('user/ferry/assets/img/RENJANA-02839bg-min.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="250" src="{{url('user/ferry/assets/img/RENJANA-02869bg-min.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="300" src="{{url('user/ferry/assets/img/RENJANA-0291bg-min.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="350" src="{{url('user/ferry/assets/img/gbr-tmbhn-green.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="400" src="{{url('user/ferry/assets/img/RENJANA-03176bg-min.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="300" src="{{url('user/ferry/assets/img/RENJANA-03021-min.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="250" src="{{url('user/ferry/assets/img/RENJANA-03032-min.jpg')}}" loading="lazy"></div>
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 mt-3"><img data-aos="fade-up" data-aos-delay="200" src="{{url('user/ferry/assets/img/gbr-tmbhn-brown.jpg')}}"></div>
            </div>
    ...
    <section class="section-information d-flex justify-content-center align-items-center" style="width: 100%;">
        <div class="wrap-info">
            ...
            <h1 class="text-wedding-date">05 Juni 2021</h1>
        ...
        <div class="information-detail container text-center d-flex align-items-center justify-content-center flex-column">
            <div class="location">
                <div data-aos="fade-up">
                    ...
                    <p data-aos="fade-up">07.00 - 08.00</p>
                </div>
                <div data-aos="fade-up"></div>
                <div data-aos="fade-up">
                    <p data-aos="fade-up">Resepsi</p>
                    <p data-aos="fade-up">11.00 - 15.00</p>
                </div>
            </div>
            ...
            <div data-aos="fade-up" style="margin-top: 70px;">
                ...
                <p data-aos="fade-up" style="margin-bottom: 0;">Taman Hummus Bintaro<br></p>
                <p data-aos="fade-up" style="margin-bottom: 0px;font-weight:300;font-size:12px;color:white;">Taman Hummuss Jl. Jend. Sudirman. Bintaro Sektor 9<br></p>
            </div><a data-bs-hover-animate="pulse" class="btn btn-direction" href="https://goo.gl/maps/uoxVGc991HKKoigr9">Petunjuk Arah</a>
        </div>
    </section>
    <section id="rsvp" class="section-rsvp">
        <div class="form-wrapper">
            ...
            <form action="{{route('ferrystore')}}" method="post" >
    ...
    <section class="section-gift">
        <div class="container wrapper">
            ...
            <p>Bagikan kebahagian bersama Ferry &amp; Nitia<br></p>
         
            <div class="content-wrapper mt-5"><img class="amplop-ats items" src="{{url('template/jasmine/assets/img/amplop-ats.png')}}"><img class="kertas items" src="{{url('user/ferry/assets/img/qrcodeBCA.png')}}"><img class="amplop-bwh items" src="{{url('template/jasmine/assets/img/amplop-bwh.png')}}"></div>
        </div>
    </section>
