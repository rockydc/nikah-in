...
@extends('layouts.user.ari.index')
...
<div class="carousel slide carousel-fade" data-ride="carousel" id="carousel-1">
        ...
        @if($value['isActive'] == true)
            <div class="carousel-item active "><img class="img-fluid w-100 d-block" src="{{$pathFileImg}}{{$value['img']}}" style="object-fit:cover;object-position:80% 20%" alt="Slide Image"></div>
         
         @else
            <div class="carousel-item"><img class=" w-100 d-block" style="object-fit:cover;object-position:80% 20%" src="{{$pathFileImg}}{{$value['img']}}" alt="Slide Image" ></div>
        @endif
            @endforeach
        </div>
        <!-- <div>
    ...
    <div id="section-love" class="section" style="background: #f6ece2;">
        <div data-aos="zoom-in">
            <h2 class="text-center" style="margin-bottom: 19px;font-family: moonTime, sans-serif;font-size:80px;font-weight: normal;color: rgb(126,99,79);">{{$layouts['sectionLove']['title']}}</h2>
            <p class="text-center" style="letter-spacing: 4px;color: rgb(126,99,79);">“ {{$layouts['sectionLove']['quote']}} “<br></p>
            @if($layouts['sectionLove']['isQuoteBlockActive'])
            <p class="text-center"
                style="color: rgb(126,99,79);">{{$layouts['sectionLove']['quoteBlock']}}<br></p>
            @endif
        </div>
    </div>
...
@endif
            ...
            <div class="form-wrapper p-lg-4 p-md-4 p-sm-1">
                ...
                @csrf 
                    ...
                    <div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group"><label>Wedding pray</label><textarea required class="form-control" name="pesan"></textarea></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group text-center d-flex align-items-center justify-content-center">
                                    ...
                                    <option value="4">4 Person</option></select></div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="section-gallery" class="section text-center">
        ...
        <div class="img-wrapper"><img  class="img-items" src="{{$pathFileImg}}{{$value}}"></div>
        @endforeach
    ...
    <!-- <img class="img-location" src="{{url('aness/assets/img/location-removebg-preview.png')}}"> -->
        ...
        <p style="font-size:20px; font-family:'Josefin Sans', sans-serif;">Resepsi</p>
        <iframe allowfullscreen="" frameborder="0" src={{$datapengantin['map_link']}}&amp;zoom=15"
                width="100%" height="400"></iframe></div>
    </div>
    @if($layouts['isSectionGiveActive'] != false)
    <div id="share-the-love" class="section text-center">
        ...
        <div class="wrapper-love d-flex justify-content-center align-items-center flex-column">
            <p style="letter-spacing: 4px;color: rgb(126,99,79);"> We Also Provide Cash Less
                ...
                <img class="mt-4 img-barcode" src="{{$pathFileImg}}{{$value['img']}}">
