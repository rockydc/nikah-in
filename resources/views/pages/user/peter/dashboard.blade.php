@extends('layouts.user.peter.dashboard')
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <!-- <button class="btn btn-link btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button"><i class="fas fa-ellipsis-v text-gray-400"></i></button> -->
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--fade-in">
                                        <p class="text-center dropdown-header">Menu</p><a class="dropdown-item" href="{{route('peterrsvp')}}">Lihat Semua</a>
                            ...
                            <div class="col d-flex align-items-center justify-content-center mb-4"><a style="color:black;" href="{{route('peterrsvp')}}">Lihat Semua</a></div>
