    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Portofolio</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <div class="d-flex justify-content-center">
                    <form action="{{route('portofolio.store')}}" method="post" enctype="multipart/form-data" class="d-flex justify-content-center flex-column">
                    @csrf
                    <label class="mt-4">Nama Portofolio</label>
                    <input class="form-control " type="text" name="nama" placeholder="nama Portofolio" />
                    <label class="mt-4">Nama URL</label>
                    <input class="form-control " type="text" name="nama_url" placeholder="nama url" />
